...
class Status(BaseModel):
    ...
    active_warnings: list[WarningType]
...
class TelemetryEntryBase(BaseModel):
...
class TelemetryEntryCreate(TelemetryEntryBase):
    pass


class TelemetryEntryResponse(TelemetryEntryBase):
    id: int
